...
const CartItem = ({
  item: { id, title, text, img, shadow, price, cartQuantity, color },
}) => {
      ...
      <div className="flex items-center justify-between w-full px-5">
        <div className="flex items-center gap-5">
          ...
          <div className="grid items-center gap-4">
            ...
            <div className="flex items-center justify-around w-full">
              ...
              <div className="bg-theme-cart rounded text-white font-medium lg:text-xs w-7 h-6 lg:w-6 flex items-center justify-center">
                {cartQuantity}
              </div>
              <button
                type="button"
        ...
        <div className="grid items-center gap-5">
          ...
          <div className="grid items-center justify-center">
            ...
            >
              <FiTrash2 className="w-5 h-5 text-white stroke-[2]" />
            </button>
          </div>
        </div>
      </div>
