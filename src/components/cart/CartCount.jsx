    ...
    <>
      <div className="bg-white h-11 flex items-center justify-between px-3 sticky top-0 left-0 right-0 w-full">
        <div className="flex items-center gap-3">
          ...
          >
            <AiOutlineDoubleLeft className="w-5 h-5 text-slate-900 hover:text-orange-500 stroke-[2]" />
          </div>
        ...
        <div className="flex items-center right-0">
          <button
            type="button"
            className="rounded bg-theme-cart active:scale-90 p-0.5 right-0"
            onClick={onClearCartItem}
          >
            <AiOutlineClose className="w-5 h-5 text-white stroke-[2] right-0" />
          </button>
        </div>
      </div>
    </>
